        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Teacher_FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Teacher_MiddleName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Teacher_LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "Introduction to Programming (C#)" });

            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "Id", "CategoryId", "Name" },
                values: new object[] { 2, 1, "Object-Oriented Programming (C#)" });
